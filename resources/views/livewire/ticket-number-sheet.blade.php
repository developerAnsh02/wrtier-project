<div class="container-fluid">
    ...
    <!-- Modals for Comments -->
    @foreach ($orders as $order)
    <div class="modal fade" id="commentsModal{{$order->id}}" tabindex="-1" aria-labelledby="commentsModalLabel{{$order->id}}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="commentsModalLabel{{$order->id}}">Comments for Order {{$order->order_id}}</h5>
