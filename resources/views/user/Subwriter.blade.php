                    ...
                    <form class="form p-t-20" action="" method="post" id="writerdata">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" id="name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-success waves-effect waves-light m-r-10 text-white add_writer">Submit</button>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <a class="delete-btn" onclick="deactivate({{$writet->id}})" data-bs-toggle="tooltip" data-original-title="Close">
