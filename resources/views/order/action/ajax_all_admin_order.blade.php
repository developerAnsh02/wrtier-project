...
<script>
    function editDate(OrderId) {
        ...
        let tl_id = $('#tl_select' + OrderId).val();
        let status = $('#status' + OrderId).val();
        let writer_ids = $('#writer' + OrderId).val(); // Get selected writer ids
        ...
        $.ajax({
            ...
            data: {
                ...
                tl_id: tl_id,
                status: status,
                writers: writer_ids  // Send writer ids
            },
            success: function(data) {
                $('.table').load(location.href + ' .table');           
                let row = $('#order-row-' + OrderId);
